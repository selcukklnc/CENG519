...
if __name__ == "__main__":
    ...
    for nc in range(36,64,4): # Node counts for experimenting various graph sizes
        ...
        for i in range(simcnt):
            ...
            res = str(n) + "," + str(1) + "," + str(i) + "," + str(compiletime) + "," + str(keygenerationtime) + "," +  str(encryptiontime) + "," +  str(executiontime) + "," +  str(decryptiontime) + "," +  str(referenceexecutiontime) + "," +  str(mse) + "\n"
            print(res)
